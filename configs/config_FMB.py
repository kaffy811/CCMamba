...
# FMB: similar to MFNet -- low baseline, sufficient training data (1220 imgs),
# class imbalance, nighttime urban driving scene with strong cross-modal complementarity.
# Use the same aggressive mask distillation settings as MFNet.
